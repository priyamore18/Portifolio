        ...
        <nav className={`fixed top-0 w-full z-50 transition duration-300 px-[7vw] md:px-[7vw] lg:px-[20vw]${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md" : "bg-transparent"
            ...
            <div className='text-white py-5 flex justify-between items-center '>
                ...
                <ul className='hidden md:flex space-x-8 text-gray-300'>
                    {menuItems.map((item) => (
                        <li key={item.id} className={`cursor-pointe hover:text-[#8245ec] ${activeSection === item.id ? "text-[#8245ec]" : ""
                            }`}>
                ...
                <div className='hidden md:flex space-x-4'>
                    <a href='https://github.com/priyamore18'
                        target='_blank'
                        className='text-gray-300 hover:text-[#8245ec]'>
                        <FaGithub size={24} />
                    </a>
                    <a href='https://www.linkedin.com/in/priya-more-a05b25255'
                        target='_blank'
                        className='text-gray-300 hover:text-[#8245ec]'>
                        <FaLinkedin size={24} />
                    </a>
